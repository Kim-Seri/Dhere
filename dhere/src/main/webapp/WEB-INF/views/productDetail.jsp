			...
			<div class="col">
				...
				<div class="row mt-5">
					<div class="col-8 offset-2 text-center">
						<input type="button" value="뒤로가기" class="btn" style="border: 2px solid rgb(49, 108, 244); width: 25%; height: 50px; border-radius: 15px; color: rgb(49, 108, 244); font-weight: bold;" onclick="goBack()">
					</div>
				</div>
			</div>
		</div>
